L.Control.basemapsSwitcher = L.Control.extend({
  ...
  onAdd: function (map) {
    const container = (this.container = L.DomUtil.create(
      "div",
    ...
    // Add click event to toggle the sidebar or perform any desired action
    container.addEventListener("click", () => {
      // Toggle the sidebar visibility or any other action on click
      if (this._isExpanded) {
        this._collapse();
      } else {
        this._expand();
